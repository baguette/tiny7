    ...
    _OP_DEF(opexe_2, "bytevector",                     0,  INF_ARG, TST_BYTE,                        OP_BYTEVECTOR       )
    _OP_DEF(opexe_2, "make-vector",                    1,  2,       TST_NATURAL TST_ANY,             OP_MKVECTOR         )
    _OP_DEF(opexe_2, "make-bytevector",                1,  2,       TST_NATURAL TST_BYTE,            OP_MKBYTEVECTOR     )
    _OP_DEF(opexe_2, "vector-length",                  1,  1,       TST_VECTOR,                      OP_VECLEN           )
    _OP_DEF(opexe_2, "bytevector-length",              1,  1,       TST_BYTEVECTOR,                  OP_BYTEVECLEN       )
    _OP_DEF(opexe_2, "vector-ref",                     2,  2,       TST_VECTOR TST_NATURAL,          OP_VECREF           )
    _OP_DEF(opexe_2, "bytevector-u8-ref",              2,  2,       TST_BYTEVECTOR TST_BYTE,         OP_BYTEVECREF       )
    _OP_DEF(opexe_2, "vector-set!",                    3,  3,       TST_VECTOR TST_NATURAL TST_ANY,  OP_VECSET           )
    _OP_DEF(opexe_2, "bytevector-u8-set!",             3,  3,       TST_BYTEVECTOR TST_NATURAL TST_BYTE, OP_BYTEVECSET   )
    ...
    _OP_DEF(opexe_3, "bytevector?",                    1,  1,       TST_ANY,                         OP_BYTEVECTORP      )
    ...
    _OP_DEF(opexe_5, 0,                                0,  0,       0,                               OP_PBVECFROM        )
    ...
    _OP_DEF(opexe_6, "get-closure-environment",        1,  1,       TST_NONE,                        OP_GET_CLOSURE_ENV  )
